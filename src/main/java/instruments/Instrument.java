...
//        You are being asked to model a music shop. This shop will contain items which can be sold.
...
//        Each item which can be sold will have both a price at which the shop bought the item, and a price at which the item will be sold.
//
//        You will need to:
//
...
//
//        Create an Instrument superclass which contains attributes you see as being common to all instruments e.g. material it is made from, colour, type (Brass, String, Woodwind, Keyboard etc).
